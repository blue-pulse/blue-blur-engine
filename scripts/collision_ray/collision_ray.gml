function collision_ray(hor_offset, ver_offset, angle, object) {
	...
	// Setup positions
	var pos_x_1 = pos_x - (cosine * hor_offset) + (sine * ver_offset);
	var pos_y_1 = pos_y + (sine * hor_offset) + (cosine * ver_offset);
