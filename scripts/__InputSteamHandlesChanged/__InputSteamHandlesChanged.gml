...
function __InputSteamHandlesChanged()
{
    ...
    with(_system)
    {
        ...
        repeat(array_length(__gamepadArray))
        {
            ...
            if (is_struct(_gamepad) and (_gamepad.__steamHandle != undefined) 
            and (_gamepad.__steamHandleIndex != steam_input_get_gamepad_index_for_controller(_gamepad.__steamHandle)))
            {
