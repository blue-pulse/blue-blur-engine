...
#macro SSAVE_DIRECTORY "savedata"    // The directory that saves are saved to
...
#macro SSAVE_ENCRYPTION_KEY 96870226967046913394692936946    // When using SSAVE_PROTECTION.ENCRYPT, this is the key used to encrypt it
