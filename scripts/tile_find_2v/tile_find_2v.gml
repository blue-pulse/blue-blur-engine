function tile_find_2v(pos_x_1, pos_y_1, pos_x_2, pos_y_2, to_positive, object_angle, tilelayer) {
	// Get tiles at positions
	var found_tile_1 = tile_find_v(pos_x_1, pos_y_1, to_positive, tilelayer);
	var found_tile_2 = tile_find_v(pos_x_2, pos_y_2, to_positive, tilelayer);
