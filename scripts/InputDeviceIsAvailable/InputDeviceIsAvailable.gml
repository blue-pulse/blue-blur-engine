...
function InputDeviceIsAvailable(_device)
{
    ...
    if ((_device >= 0) and INPUT_BAN_GAMEPADS) return false;
    if ((_device == INPUT_KBM) and INPUT_BAN_KBM) return false;
    if ((_device == INPUT_TOUCH) and INPUT_BAN_TOUCH) return false;
